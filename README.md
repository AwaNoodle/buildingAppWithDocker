...
From the host machine, navigate to [http://localhost:9123](http://localhost:9123) and you should see your new site.
...
You can now navigate to [http://localhost:7788](http://localhost:7788) and see the app running with our base message. You can use a tool like [Postman](https://www.getpostman.com/) or [cURL](http://curl.haxx.se/docs/manpage.html) to navigate to our API and check that it is working. Try navigating to [http://localhost:7788/api/whereis/tim](http://localhost:7788/api/whereis/tim) and [http://localhost:7788/api/whereis/luke](http://localhost:7788/api/whereis/luke) and check the response codes.
